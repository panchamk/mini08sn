...
namespace DocClass.Src.Learning.MathOperations
{
    public static class Blas
    {
        ...
        public static double VectorNorm2(ref double[] x, int i1, int i2)
        {
            ...
            for (ix = i1; ix <= i2; ix++)
            {
                if (x[ix] != 0)
                {
                    ...
                    if (scl < absxi)
                    {
                        ssq = 1 + ssq * Common.Sqr(scl / absxi);
                        scl = absxi;
                    }
                    else
                    {
                        ssq = ssq + Common.Sqr(absxi / scl);
                    }
                }
            }
            ...
            int jd2)
        {
            ...
            Debug.Assert(is2 - is1 == id2 - id1, "CopyMatrix: different sizes!");
            Debug.Assert(js2 - js1 == jd2 - jd1, "CopyMatrix: different sizes!");
            ...
            ref double[] work)
        {
            ...
            Debug.Assert(i1 - i2 == j1 - j2, "InplaceTranspose error: incorrect array size!");
            for (i = i1; i <= i2; i++)
            {
                j = j1 + i - i1;
                ips = i + 1;
            ...
            int jd2)
        {
            ...
            Debug.Assert(is2 - is1 == jd2 - jd1, "CopyAndTranspose: different sizes!");
            Debug.Assert(js2 - js1 == id2 - id1, "CopyAndTranspose: different sizes!");
            for (isrc = is1; isrc <= is2; isrc++)
            {
                jdst = isrc - is1 + jd1;
                i1_ = (js1) - (id1);
            ...
            double beta)
        {
            ...
            if (!trans)
            {
                ...
                Debug.Assert(j2 - j1 == ix2 - ix1, "MatrixVectorMultiply: A and X dont match!");
                Debug.Assert(i2 - i1 == iy2 - iy1, "MatrixVectorMultiply: A and Y dont match!");
            ...
            else
            {
                ...
                Debug.Assert(i2 - i1 == ix2 - ix1, "MatrixVectorMultiply: A and X dont match!");
                Debug.Assert(j2 - j1 == iy2 - iy1, "MatrixVectorMultiply: A and Y dont match!");
            ...
            double y)
        {
            ...
            {
                result = w * Math.Sqrt(1 + Common.Sqr(z / w));
            }
            return result;
        }
            ...
            ref double[] work)
        {
            ...
            Debug.Assert(acols == brows, "MatrixMatrixMultiply: incorrect matrix sizes!");
